...
class CharacterMotorMovement {
	...
	var maxForwardSpeed: float = OnStartGame.paraArray[1];
	var maxSidewaysSpeed : float = OnStartGame.paraArray[1];
	var maxBackwardsSpeed : float = OnStartGame.paraArray[1];
	//
	*/
	
	
	public static var maxForwardSpeed : float = 10.0;
	public static var maxSidewaysSpeed : float = 10.0;
	public static var maxBackwardsSpeed : float = 10.0;
